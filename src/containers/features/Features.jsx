...
const Features = () => {
  return (
    <div className='gpt3__features section__padding' id='features'>
      ...
      <div className='gpt3__features-content_container'>
        <Feature title="Improving end distrust instantly" text="From they fine john he give of rich he. They age and draw mrs like. Improving end distrusts may instantly was household applauded." />
